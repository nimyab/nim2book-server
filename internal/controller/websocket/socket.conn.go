...
// MakeSocketConnHandler creates WebSocket handler with dependencies
func MakeSocketConnHandler(cfg *config.Config) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		payload, err := jwt.ParseToken(token, cfg.JWTSecret)
		if err != nil {
