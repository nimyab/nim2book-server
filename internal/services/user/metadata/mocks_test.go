...
func (_mock *MockUserRepository) GetByID(ctx context.Context, id domain.ID) (*domain.User, error) {
	...
	var r0 *domain.User
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, domain.ID) (*domain.User, error)); ok {
		return returnFunc(ctx, id)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, domain.ID) *domain.User); ok {
...
func (_c *MockUserRepository_GetByID_Call) Run(run func(ctx context.Context, id domain.ID)) *MockUserRepository_GetByID_Call {
...
func (_c *MockUserRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, id domain.ID) (*domain.User, error)) *MockUserRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
