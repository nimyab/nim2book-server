...
func (e AuthorEdges) PersonalBooksOrErr() ([]*PersonalBook, error) {
	if e.loadedTypes[0] {
...
// QueryPersonalBooks queries the "personal_books" edge of the Author entity.
func (_m *Author) QueryPersonalBooks() *PersonalBookQuery {
	return NewAuthorClient(_m.config).QueryPersonalBooks(_m)
}
