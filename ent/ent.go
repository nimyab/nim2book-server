...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			basicaccount.Table:        basicaccount.ValidColumn,
			book.Table:                book.ValidColumn,
			bookchapter.Table:         bookchapter.ValidColumn,
			dictionary.Table:          dictionary.ValidColumn,
			dictionaryexample.Table:   dictionaryexample.ValidColumn,
			fcmtoken.Table:            fcmtoken.ValidColumn,
			genre.Table:               genre.ValidColumn,
			googleaccount.Table:       googleaccount.ValidColumn,
			personalbook.Table:        personalbook.ValidColumn,
			personalbookchapter.Table: personalbookchapter.ValidColumn,
